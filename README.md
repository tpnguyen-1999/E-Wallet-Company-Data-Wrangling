...
## 1. Introduction
This project aims to analyze important datasets from an E-wallet company to uncover valuable business insights. The primary goal is to explore payment volumes, product information, and transaction patterns.
