...
## 1. Introduction
This project utilizes Python to extract strategic insights from key datasets provided by an E-wallet company. It focuses on analyzing payment volumes, product performance, and transaction patterns to support data-driven decision-making and promote business growth.
...
## 2. Dataset Overview
Three datasets are used in this project for analysis.
